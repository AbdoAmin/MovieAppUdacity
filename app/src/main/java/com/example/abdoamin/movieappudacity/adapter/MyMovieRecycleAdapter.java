...
public class MyMovieRecycleAdapter extends RecyclerView.Adapter<MyMovieRecycleAdapter.ViewHolder> {

    private List<Movie> movies;
    private int movieLayout;
    private Context context;

    public MyMovieRecycleAdapter(List<Movie> movies, int movieLayout, Context context) {
        this.movies = movies;
